 ...
 * @param {string[]} [options.skipAuthEndpoints] - Danh sách endpoint không cần retry refresh (chỉ dùng cho IdentityService)
...
export function createServiceAxios(baseURL, options = {}) {
  ...
  instance.interceptors.response.use(
    ...
    async (error) => {
      ...
      // Kiểm tra xem endpoint hiện tại có nằm trong danh sách bỏ qua không
